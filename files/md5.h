...
// 修改部分（增）
#define F_NEON(x,y,z) vorrq_u32(vandq_u32(x,y),vbicq_u32(z,x))
#define G_NEON(x,y,z) vorrq_u32(vandq_u32(x,z),vbicq_u32(y,z))
...
void MD5Hash_SIMD(std::string input[4], bit32 state[4][4]);
